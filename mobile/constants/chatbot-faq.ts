 ...
 * Portado do chatbot-faq.js do web.
 */
...
export const FAQ_TREE: Record<string, FaqNode> = {
    /* ── Boas-vindas (Premium) ─────────────────────────────────────────────── */
    welcome: {
    ...
    /* ── Boas-vindas (Free) ────────────────────────────────────────────────── */
    welcome_free: {
        text: 'Olá! 👋 Sou o assistente virtual do Finanças. No plano Free você pode fazer um tour pelas funcionalidades disponíveis, ou conhecer o que o Premium oferece!',
        options: [
    ...
    free_premium_info: {
        text: 'O plano Premium desbloqueia: Dashboard completo, Metas financeiras, Inteligência, Saúde Financeira (regra 50-30-20), Relatórios detalhados e este Assistente virtual completo.',
        options: [
            { label: '💬 Falar com assistente', next: 'main_menu' },
    ...
    q_edit_transaction: {
        text: 'Na lista de ganhos ou gastos, toque no ícone de lápis ✏️ para editar ou na lixeira 🗑️ para excluir um lançamento.',
        options: [
            { label: 'Outra dúvida sobre Ganhos & Gastos', next: 'income_expense' },
            { label: '↩️ Menu principal', next: 'main_menu' },
        ],
    ...
    q_pay_bill: {
        text: 'Em cada card de conta fixa há um botão "Pagar". Ao tocar, o mês atual é marcado como pago e o card muda de cor para indicar adimplência.',
        options: [
            { label: 'Outra dúvida sobre Contas Fixas', next: 'bills' },
            { label: '↩️ Menu principal', next: 'main_menu' },
        ],
    ...
    q_deactivate_bill: {
        text: 'No card da conta fixa, toque no ícone de edição ✏️ e desmarque a opção "Ativa". A conta deixa de aparecer nos meses seguintes.',
        options: [
            { label: 'Outra dúvida sobre Contas Fixas', next: 'bills' },
            { label: '↩️ Menu principal', next: 'main_menu' },
        ],
    ...
    q_contribute_goal: {
        text: 'No card da meta, clique em "Aportar". Informe o valor e uma nota opcional. O valor é somado ao progresso e o histórico fica registrado.',
        options: [
            { label: 'Outra dúvida sobre Metas', next: 'goals' },
            { label: '↩️ Menu principal', next: 'main_menu' },
        ],
    ...
    q_upgrade: {
        text: 'Toque no seu avatar no canto inferior do menu lateral → "Minha Conta". Lá você encontra a opção para fazer upgrade para o plano Premium.',
        options: [
    ...
    q_plans: {
        text: 'O plano Free oferece Ganhos, Gastos e Contas Fixas. O Premium adiciona Dashboard, Metas, Inteligência, Saúde Financeira, Investimentos e Relatórios.',
        options: [
            { label: 'Outra dúvida sobre Conta', next: 'account' },
            { label: '↩️ Menu principal', next: 'main_menu' },
        ],
    ...
    q_change_pass: {
        text: 'Acesse "Minha Conta" pelo seu avatar no menu lateral. Você pode alterar seu nome, e-mail e senha no formulário exibido.',
        options: [
            { label: 'Outra dúvida sobre Conta', next: 'account' },
            { label: '↩️ Menu principal', next: 'main_menu' },
        ],
    ...
    q_logout: {
        text: 'Toque no ícone de saída (🚪) ao lado do seu nome no rodapé do menu lateral. Sua sessão será encerrada com segurança.',
        options: [
            { label: 'Outra dúvida sobre Conta', next: 'account' },
            { label: '↩️ Menu principal', next: 'main_menu' },
        ],
...
export const RESTART_OPTION: FaqOption = {
    label: '🔄 Reiniciar conversa',
    next: '__welcome__',
};

export const WELCOME_NODES = new Set(['welcome', 'welcome_free']);
